...
| `au-nsw-bhs` | Bathurst and Central West scoped traffic. | <CopyCommand command="region put au-nsw-wol" /><br /><CopyCommand command="region allowf au-nsw-wol" /> | Bathurst |
